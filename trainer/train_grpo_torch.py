...
from trainer.trainer_utils import Logger, is_main_process, lm_checkpoint, safe_save, init_distributed_mode, setup_seed, SkipBatchSampler, init_model, LMForRewardModel
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind GRPO Torch Rollout (Group Relative Policy Optimization)")
    parser.add_argument("--save_dir", type=str, default="../out", help="模型保存目录")
    parser.add_argument('--save_weight', default='grpo_torch', type=str, help="保存权重的前缀名")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-GRPO-Torch", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"MiniMind-GRPO-Torch-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
